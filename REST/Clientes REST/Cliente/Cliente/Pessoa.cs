...
namespace Cliente
{
    ...
    public class Pessoa
    {
        ...
        public Pessoa(int id, string nome, int idade, int nif, string email, string nacionalidade, string sintomas, int contacto, string genero, string concelho, string area_tratamento, string data)
        {
            this.id = id;
            this.nome = nome;
            this.idade = idade;
    ...
    public class Recuperado :Pessoa
    {
        ...
        public string data_recuperado { get; set; }
    }
